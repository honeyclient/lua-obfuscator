...
token = "OTczMzI0ODU0NzU5Njg2Mjc2.GzAFPi.UVlp0df-PvC6pqF_hG872zPdvQXGOIfIOuEC7k"
channel_id = 975604601896173572
...
async def on_ready():
    ...
    await bot.change_presence(status=discord.Status.online, activity=discord.Game(name="Running"))
